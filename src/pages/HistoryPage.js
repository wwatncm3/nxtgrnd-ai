...
const sampleVideos = [
  {
    ...
    description: 'Follow along as I show you what a typical day looks like as a software engineer.'
  },
  // Add more videos...
];

const HistoryPage = ({ setStage }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="ml-4 text-2xl font-bold text-gray-900">Watch History</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {sortedVideos.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">No videos in your history</p>
          </div>
        )}
      </div>
    </div>
