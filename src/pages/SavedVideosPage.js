// pages/SavedVideosPage.js
import React, { useState } from 'react';
import { ArrowLeft, Search, Filter, Grid, List, Bookmark } from 'lucide-react';
...
const sampleVideos = [
  {
    id: 1,
    title: 'Career Tips: Networking in Tech',
    thumbnail: '/api/placeholder/400/225',
    duration: '8:45',
    date: '2024-03-10',
    tags: ['Career Tips', 'Networking'],
    description: 'Learn effective networking strategies for the tech industry.'
  },
  // Add more videos...
];

const SavedVideosPage = ({ setStage }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="ml-4 text-2xl font-bold text-gray-900">Saved Videos</h1>
            </div>
