// pages/LikedVideosPage.js
import React, { useState } from 'react';
import { ArrowLeft, Search, Filter, Grid, List, ThumbsUp } from 'lucide-react';
...
const sampleVideos = [
  {
    ...
    duration: '12:30',
    date: '2024-03-12',
    tags: ['Career Tips', 'Interviews', 'Tech'],
    description: 'Essential interview tips for landing your dream tech job.'
  },
  // Add more videos...
];

const LikedVideosPage = ({ setStage }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="ml-4 text-2xl font-bold text-gray-900">Liked Videos</h1>
            </div>
